<?php
   ...
   **/
    ...
    **/       
    ...
    $plugins_path = $url."/wp-content/plugins";    
   ...
   /**
    ...
    function motivonti_header() {
      ...
      echo "<!-- Start Motivonti -->\n";
      echo "<link rel=\"stylesheet\" href=\"{$plugins_path}/citatele-lui-motivonti/style.css\" type=\"text/css\" media=\"screen\" />\n";
      echo "<!-- End Motivonti -->\n"; 
    }
   ...
   /**
     *  Cateva actiuni...
     **/             
    add_action("wp_head", "motivonti_header");
